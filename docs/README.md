...
|MD104|[whitelist-mail-and-host](./../linting-rules/whitelist-mail-and-host.js)|Locates credentials, email, url and ip prohibited in Axibase style [guide](./guide.md#example-names). See [white list](linting-rules/whitelist-mail-and-host.js#L22).|