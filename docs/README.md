...
|MD105|[blacklisted-words-for-use-cases](./../linting-rules/blacklisted-words-for-use-cases.js)|Locates [patterns](./../linting-rules/blacklisted-words.js#L24) in atsd-use-cases prohibited in Axibase style [guide](../guide.md).|