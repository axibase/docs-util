...
const rules = [
    ...
    new Rule("was\\s", "use present tense"),
    new Rule("were\\s", "use present tense"),
    new Rule("had\\s", "use present tense"),
    ...
    new Rule("\\sterminate\\s", "'stop', 'cancel'"),
    new Rule("\\sadmin\\s", "'administrator'", true),
    new Rule("\\sso\\s", "use formal style"),
    new Rule("\\sso,", "use formal style"),
